...
b.css({overflow:"hidden"}));a.wrap&&!b.parent().data("t-wrap")&&(b.wrap(d("<div/>",a.wrap[0].match(/[.#]/)?"#"==a.wrap[0]?{id:a.wrap.substr(1)}:{"class":a.wrap.substr(1)}:{style:a.wrap})),b.parent().data("t-wrap",1));f(a.caret,"s")&&!d(".t-caret",b)[0]&&(f(a.blink)&&10>a.blink&&(a.blink=10),q=d("<"+a.tag+"/>",{"class":"t-caret",html:a.caret}).appendTo(b),a.blink&&b.append("\u200b")&&(t=setInterval(function(){q.css({visibility:(q.css('visibility')[0]=='h')?'visible':'hidden'})},f(a.blink)?a.blink:a.speed*(a.speed_vary?4:5))));a.blink||clearInterval(t);a.speed=
