...
(n=String(b.data().del),!f(c,"a")&&"/"==c[1]&&(c=n.replace(/\\n/g,"\n").split([])),f(c,"a"))){if(c.pop()){b.text(c.join([]));k=!k;return}"*"==n&&(l.wrapInner(d("<"+a.tag+"/>",{"class":"typing-0",style:"display:none;"})),b=b.parent(),m&&(e=d.merge(["<"+a.tag+' class="typing-add"></'+a.tag+">"],e,["</"+a.tag+">"]),b=b.parent()));b=b.parent();"\u200b"==n&&b.find(":last").remove();c=""}"/"==c[1]&&(b=b.parent(),c=e.shift()||"");b.append(c);a.typing(l.parent(),r(),s,c);!c.match(/<ins>/)&&c.match(/></)&&
